...
export default function Introduction() {
  return (
    ...
    <div className=' flex w-5/6 mx-auto mt-24 gap-x-5 max-sm:grid max-sm:grid-cols-1 max-sm:gap-y-5 max-sm:mt-10 '>
      <div className='w-2/3 max-sm:w-full '>
        ...
        <p className='my-2 text-lg font-semibold w-4/6 text-indigo-950 max-sm:w-full'>Unleash the power of an automated demo library with a minimal effort: Demoboost supports you with all the hard work, allowing you to quickly capitalize on automated demo platform and increase your long-term value.</p>
